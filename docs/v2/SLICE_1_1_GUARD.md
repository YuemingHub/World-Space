...
**状态（2026-09-12 晚更新）：首轮真实搜索 Pilot 已执行——PARTIAL。** smoke 链路通过、
12 条完成 6 条（5 ok + 1 P0 llm_bad_json）、6 条被日预算 429 拦下；逐条人工核对与
试点发现（词表漏医疗高风险、转载死链等）见 `SEARCH_EVIDENCE_PILOT12.md`。
